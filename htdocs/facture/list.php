...
if ($user->rights->facture->creer) {
    ...
    print '<a class="button icon-star" href="facture/fiche.php?action=create">' . $langs->trans("NewBill") . '</a>';
    print "</span>";
    print "</p>";
}

print $object->datatablesEdit("listinvoices", $langs->trans("NewBill"));
...
$obj->aoColumns[$i]->fnRender = $object->datatablesFnRender("ref", "url", array('url' => 'facture/fiche.php?id='));
$i++;
print'<th class="essential">';
...
$obj->aoColumns[$i]->sDefaultContent = "INVOICE_STANDARD";
