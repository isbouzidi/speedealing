 ...
 */
class pdf_bl extends ModelePDFCommandes {
...
// Defini position des colonnes
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs) {
		...
		$pdf->SetXY($posx, $posy);
		$pdf->SetTextColor(0, 0, 60);
		$title = $outputlangs->transnoentities("Bon de livraison");
		...
		$pdf->SetXY($posx, $posy);
		$pdf->SetTextColor(0, 0, 60);
		$pdf->MultiCell(100, 3, $outputlangs->transnoentities("OrderDate") . " : " . dol_print_date(date("c", $object->datec->sec), "%d %b %Y", false, $outputlangs, true), '', 'R');
