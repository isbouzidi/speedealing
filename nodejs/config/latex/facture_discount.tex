...
\tablehead{%
\hline
\multicolumn{7}{|l|}{\small\sl suite de la page précédente}\\
\hline
\multicolumn{1}{|c}{Réf} &
\multicolumn{1}{c}{Désignation} &
TVA &
...
\tabletail{%
\hline
\multicolumn{7}{|r|}{\small\sl suite sur la prochaine page}\\
\hline}
\tablelasttail{\hline}
\begin{minipage}{\textwidth}
\flushright 
...
\end{minipage}\\
\begin{strictsupertabular*}{\textwidth}{|p{2.5cm}|p{6.0cm}@{\extracolsep{1mm plus 1fil}}|c|r|r|r|r|}
--TABULAR--
