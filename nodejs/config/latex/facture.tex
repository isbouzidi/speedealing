...
Notre Société se réserve la propriété des marchandises, même livrées, jusqu'à leur paiement
total intégral. Le défaut de paiement de l'une quelconque des échéances pourra entraîner la
revendication des bleus.\\
Ne constitue pas paiement au sens de cette clause, la remise d'un titre créant une obligation de
payer (traite ou autre).\\
Les dispositions ci-dessus ne font pas obstacle, à compter de la livraison, au transfert de
l'acheteur des risques de perte ou de détérioration.

\section{CLAUSE RÉSOLUTOIRE}
En cas d'inexécution de ses obligations par l'une des parties, le présent contrat sera résolu de
plein droit au profit de l'autre partie, sans préjudice des dommages-intérêts qui pourraient être
réclamés à la partie défaillante.

\section{CONTESTATIONS}
En cas de litige, et à défaut d'accord amiable entre les parties, seul le Tribunal de Commerce
du lieu du siège social de notre société est compétent.
