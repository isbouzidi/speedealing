...
module.exports = function (app, passport, auth, usersSocket) {
	...
	app.get('/api/tickets', auth.requiresLogin, object.read);
	app.get('/api/tickets/:id', auth.requiresLogin, object.findOne);
	app.post('/api/tickets', auth.requiresLogin, function (req, res) {
		object.create(req, res);
	});
	app.put('/api/tickets/read', auth.requiresLogin, function (req, res) {
	...
	app.put('/api/tickets/expire', auth.requiresLogin, function (req, res) {
	...
	app.post('/api/tickets/comment', auth.requiresLogin, function (req, res) {
	...
	app.put('/api/tickets/status', auth.requiresLogin, function (req, res) {
	...
	app.put('/api/tickets/percentage', auth.requiresLogin, function (req, res) {
	...
	app.put('/api/tickets/:id', auth.requiresLogin, object.update);
	app.del('/api/tickets', auth.requiresLogin, object.del);
	app.post('/api/tickets/file/:Id', auth.requiresLogin, function (req, res) {
	...
	app.get('/api/tickets/file/:Id/:fileName', auth.requiresLogin, function (req, res) {
		var id = req.params.Id;
	...
	app.del('/api/tickets/file/:Id/:fileName', auth.requiresLogin, function (req, res) {
		...
		if (fileName && id) {
			gridfs.delFile(TicketModel, id, fileName, function (err) {
				if (err)
					res.send(500, err);
				else
					res.send(200, {status: "ok"});
